    ...
    <div className={styles.content}>
      ...
      <div className={styles.type}>
        <div className={styles.item}>
          <Link to={`/video/jk?id=${current.id}`}><img src={require('../../../../assets/jiankong.png')} alt="监控设备"/></Link>
          { type === 'jk' ? <Icon type="caret-down" style={{fontSize: '22px', color: '#3992d6'}} />: ''}
        </div>
        <div className={styles.item}>
          <Link to={`/video/tj?id=${current.id}`}><img src={require('../../../../assets/shujutongji.png')} alt="统计数据"/></Link>
